...
feature_extraction_arguments <- list(
  ...
  list(transformation = TRUE, fsm = ipage_transformation, fsm_name = "ipage_bonferroni_pval_0.05", adjust_method = "bonferroni", p_value_threshold = 0.05),
  list(transformation = TRUE, fsm = ipage_transformation, fsm_name = "ipage_bonferroni_pval_0.1", adjust_method = "bonferroni", p_value_threshold = 0.1),
  list(transformation = TRUE, fsm = ipage_transformation, fsm_name = "ipage_bonferroni_pval_0.5", adjust_method = "bonferroni", p_value_threshold = 0.5),
  list(transformation = TRUE, fsm = ipage_transformation, fsm_name = "ipage_fdr_pval_0.05", adjust_method = "fdr", p_value_threshold = 0.05),
  list(transformation = TRUE, fsm = ipage_transformation, fsm_name = "ipage_fdr_pval_0.1", adjust_method = "fdr", p_value_threshold = 0.1),
  list(transformation = TRUE, fsm = ipage_transformation, fsm_name = "ipage_fdr_pval_0.5", adjust_method = "fdr", p_value_threshold = 0.5),
  list(transformation = TRUE, fsm = ipage_transformation, fsm_name = "ipage_pval_0.005", adjust_method = "none", p_value_threshold = 0.005),
  list(transformation = TRUE, fsm = ipage_transformation, fsm_name = "ipage_pval_0.01", adjust_method = "none", p_value_threshold = 0.01),
  list(transformation = TRUE, fsm = ipage_transformation, fsm_name = "ipage_pval_0.05", adjust_method = "none", p_value_threshold = 0.05),
  ...
  list(fsm = mrmr_features, filter = FALSE, fsm_name = "mrmr100_no_fil", attr_num = 100),
  list(fsm = mrmr_features, filter = FALSE, fsm_name = "mrmr_perc50_no_fil", perc_attr = 50),
